...
class Team(db.Model):
    ...
    home_games = db.relationship("SoccerGame",
                                 foreign_keys="[SoccerGame.home_team_id]",
                                 lazy="subquery")
    away_games = db.relationship("SoccerGame",
                                 foreign_keys="[SoccerGame.away_team_id]",
                                 lazy="subquery")
    ...
    def get_home_games(self):
        return [game for game in self.home_games if game.game_finished]

    def get_away_games(self):
        return [game for game in self.away_games if game.game_finished]
...
class SoccerGame(db.Model):
    ...
    def is_bye(self):
        if self._is_bye is not None:
            return self._is_bye
        self._is_bye = self.home_team.is_bye or self.away_team.is_bye
        return self._is_bye
